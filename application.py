...
from redmonty.database.sqldblib import Base, Session, engine
from redmonty.config import myapp
from redmonty.raw_routes import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'redmonty.handlers.' + m)    
            try:
                mod = importlib.import_module('redmonty.handlers.' + m)
            except:
                pass
            #print(dir(mod))
