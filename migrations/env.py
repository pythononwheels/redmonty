...
from redmonty.powlib import get_class_name
from redmonty.config import myapp
from redmonty.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('redmonty.models.sql.' + m)
...
#from redmonty.dblib import Base
