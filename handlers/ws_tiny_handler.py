...
class EchoWebSocket_tiny(PowWsHandler):
    ...
    def get_client(self,clientID):
        ...
        """
        c=self.dbclients.get(clientID, None)
        if c:
            return c
        else:
            return Tdbmodel()
